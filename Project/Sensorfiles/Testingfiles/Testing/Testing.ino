...
#define redpin 7    // pwm output for RED anode use 1K resistor
#define greenpin 6  // pwm output for GREEN anode use 2K resistor
#define bluepin 5  // pwm output for BLUE anode use 1K resistor
